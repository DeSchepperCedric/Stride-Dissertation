...
void GeoGridHDF5Reader::Read()
{
        ...
        try {
                ...
                auto               people_size = ReadAttribute<unsigned int>("size", people);
...
std::pair<std::shared_ptr<Location>, std::shared_ptr<EnhancedCoordinate>> GeoGridHDF5Reader::ParseLocation(
    H5::Group& location)
{
