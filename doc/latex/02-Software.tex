...
The format used to read and write a hdf5 file, is predefined (see \ref{hdf5_format}). If you want to see a visual representation of the format, you will have to rely on HDFView\footnote{\url{https://www.hdfgroup.org/downloads/hdfview/}}. 